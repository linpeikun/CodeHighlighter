...
<div id="mainContent" class="tool_content wrapper">
	<div class="toolName">在线代码高亮(纯代码版)</div>
...
?&gt;
	...
	<div>
	<p>使用该版本，请手工在header中嵌入如下代码：</p>

<div id="highlighter_588251" class="syntaxhighlighter  php">
...
<p>可以将shCoreDefault更换成不同的css样式。(shCoreDefault，shCoreDjango，shCoreEclipse，shCoreEmacs，shCoreFadeToGrey，shCoreMDUltra，shCoreMidnight，shCoreRDark)，也可以将css部署到自己的网站，<a href="styles.zip">点此下载</a>。</p></div>
</div>
<div id="footer">
	<p class="wrapper">
